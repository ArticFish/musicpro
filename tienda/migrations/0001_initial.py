# Generated by Django 4.0.4 on 2023-06-01 01:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idDetalle', models.AutoField(primary_key=True, serialize=False, verbose_name='ID autoincrementable del detalle producto')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idDetalle', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='tienda.detalleproducto')),
            ],
        ),
        migrations.AddField(
            model_name='detalleproducto',
            name='idTipopro',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='tienda.tipopro'),
        ),
        migrations.CreateModel(
            name='carrito',
            fields=[
